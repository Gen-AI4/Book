    ...
    async def process_chat_request(self, request: ChatRequest) -> ChatResponse:
        ...
        try:
            ...
            system_prompt = (
                ...
                "You are a Physical AI Teaching Assistant. You can only answer questions related to the textbook content. No general knowledge questions can be answered. If the user asks a question not related to the textbook, politely explain that you can only help with physical AI concepts from the textbook."
            )
            ...
            if not context_retrieved:
                ...
                if ("i don't know" not in response_text.lower() and
                    ...
                    response_text = "I'm a Physical AI Teaching Assistant. I can only answer questions related to the textbook content. I cannot answer general knowledge questions that are outside the scope of the provided book materials."
